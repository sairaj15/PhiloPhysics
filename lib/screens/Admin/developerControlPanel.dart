...
class _DeveloperControlPanelState extends State<DeveloperControlPanel> {
  ...
  Future<void> confirmSwitchChange(String title, String field, bool currentValue) async {
  ...
  Future<void> editVersion(String field, String currentVersion) async {
    List<int> parts = currentVersion.split(".").map((e) => int.tryParse(e) ?? 0).toList();
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text("Change the app version of '$field' to the latest version",
                                  style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        buildModernPickerBox(value: major, onChanged: (v) => major = v, label: "Major"),
                        buildModernPickerBox(value: minor, onChanged: (v) => minor = v, label: "Minor"),
                        buildModernPickerBox(value: patch, onChanged: (v) => patch = v, label: "Patch"),
                      ],
                    ),
  ...
  Widget _buildShimmerTile(BuildContext context,
      {bool hasSwitch = false, bool hasTrailingText = false, required int index}) {
  ...
  Widget buildSettingsList(
    ...
    final Color tileColor = color5.withOpacity(0.2);
    ...
    final List<Map<String, dynamic>> settings = [
      {
        ...
        'trailing': (context) => Transform.scale(
          ...
          child: Switch(
            value: forceUpdate,
            onChanged: (_) =>
                confirmSwitchChange("Force Update", "forceUpdate", forceUpdate),
          ),
        ),
      },
      {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
        const Text("Developer Control Panel", style: TextStyle(color: Colors.white)),
